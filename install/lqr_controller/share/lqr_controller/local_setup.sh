...
: ${AMENT_CURRENT_PREFIX:="/home/lzy/ros2_study/balance_car_ws/install/lqr_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lqr_controller/environment/library_path.sh"
