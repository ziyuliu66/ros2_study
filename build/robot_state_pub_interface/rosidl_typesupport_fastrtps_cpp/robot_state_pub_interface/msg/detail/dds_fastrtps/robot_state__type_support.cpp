...
#include "robot_state_pub_interface/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: set_effort
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.set_effort[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_state_pub_interface::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_state_pub_interface::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_state_pub_interface::msg::RobotState *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_robot_state_pub_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<robot_state_pub_interface::msg::RobotState>()
{
  return &robot_state_pub_interface::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
